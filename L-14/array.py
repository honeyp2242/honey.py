# 1. Create a 1D Array (list) with five integer display the array using a loop.
...
# 4. Insert a new Element at a spcific position in a 1D array.
...
#     print("Element not Found in index : " , list.index(search_element))
# else:
